...
class sample(_object):
    ...
    def print_infoA(self, a):
        return _sample.sample_print_infoA(self, a)

    def print_infoVoid(self, a):
        return _sample.sample_print_infoVoid(self, a)

    def print_info(self, i):
        return _sample.sample_print_info(self, i)

    def __init__(self):
        this = _sample.new_sample()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _sample.delete_sample
    __del__ = lambda self: None
sample_swigregister = _sample.sample_swigregister
